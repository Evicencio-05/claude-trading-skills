...
----------------------------------------------------------------------
  Fetching detail CSV from https://tradermonty.github.io/market-breadth-analysis/market_breadth_data.csv... OK (2512 rows, 2016-05-31 to 2026-05-27)
  Fetching summary CSV from https://tradermonty.github.io/market-breadth-analysis/market_breadth_summary.csv... OK (12 metrics)
  Data freshness: OK (latest: 2026-05-27, 1 days old)

Step 2: Calculating Components
----------------------------------------------------------------------
  [1/6] Current Breadth Level & Trend... Score: 57 (NEUTRAL: 8MA=0.577 in downtrend - mixed signals)
  [2/6] 8MA vs 200MA Crossover... Score: 45 (NEUTRAL: Near crossover (gap=-0.018, 8MA rising) (recovery signal))
  [3/6] Peak/Trough Cycle Position... Score: 45 (PEAK (58d ago): recovery attempt, 8MA rising)
  [4/6] Bearish Signal Status... Score: 25 (WARNING (muted): Bearish signal active in downtrend, but 8MA=0.577 still relatively strong [PINK ZONE])
  [5/6] Historical Percentile... Score: 30 (LOW: 27th percentile - below average breadth)
  [6/6] S&P 500 vs Breadth Divergence... Score: 34.0 (Dangerous bearish divergence: S&P +10.6%, Breadth 8MA -0.089 over 60d)
...
----------------------------------------------------------------------
  JSON report saved to: reports/pre_market/market_breadth_2026-05-28_204520.json
  Markdown report saved to: reports/pre_market/market_breadth_2026-05-28_204520.md
...
======================================================================
  ...
  Health Zone: Neutral
  Equity Exposure: 60-75%
  JSON Report: reports/pre_market/market_breadth_2026-05-28_204520.json
  Markdown Report: reports/pre_market/market_breadth_2026-05-28_204520.md
```
...
Step 4: Generating Reports
----------------------------------------------------------------------
JSON report saved to: reports/pre_market/uptrend_analysis_2026-05-28_204521.json
Markdown report saved to: reports/pre_market/uptrend_analysis_2026-05-28_204521.md
...
======================================================================
  ...
  Zone: Neutral
  Exposure Guidance: Reduced Exposure (60-80%)
  JSON Report: reports/pre_market/uptrend_analysis_2026-05-28_204521.json
  Markdown Report: reports/pre_market/uptrend_analysis_2026-05-28_204521.md
```
