...
**Date:** 2026-05-31
**Tier:** Starter ($29/mo, 300 API calls/minute)
...
| `stable/sp500-constituent` | 402 | No | Requires **Premium ($69/mo)** |
...
| `vcp-screener` default S&P 500 | Blocked on Starter — use `--universe` or Premium tier |
