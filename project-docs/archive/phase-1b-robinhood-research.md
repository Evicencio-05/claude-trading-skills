...
Maintain via weekly `update_stale_research.py` (timer or `--dry-run`). Counts toward 5+ exit include Phase 1 reports; **3 current**, 3 need update-research. Watchlist YAML: `config/research_watchlist.yaml`.
