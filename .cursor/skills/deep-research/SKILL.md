...
2. **Pass 1 — Collect:** Execute only manifest `action=run` items plus ticker-specific always-run steps. Save new outputs under `reports/`. Do not write the final report yet.
